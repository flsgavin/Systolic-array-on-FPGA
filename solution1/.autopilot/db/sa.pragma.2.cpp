# 1 "testTPU/src/sa.cpp"
# 1 "testTPU/src/sa.cpp" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 152 "<built-in>" 3
# 1 "<command line>" 1
...
# 3 "testTPU/src/sa.cpp" 2

void load_matrix_from_buffer(int buf_weight[32 * 1024], int buf_feature[32 * 1024], int A_start, int B_start, int A[32][32], int B[32][32]){_ssdm_SpecArrayDimSize(buf_weight, 32768);_ssdm_SpecArrayDimSize(buf_feature, 32768);_ssdm_SpecArrayDimSize(A, 32);_ssdm_SpecArrayDimSize(B, 32);
...
# 30 "testTPU/src/sa.cpp"
void write_back_to_result_buffer(int C[32][32], int buf_result[32 * 1024], int buf_start_addr){_ssdm_SpecArrayDimSize(C, 32);_ssdm_SpecArrayDimSize(buf_result, 32768);
_ssdm_SpecArrayReshape( C, 2,  "COMPLETE",  0, "");
 if(buf_start_addr + (32 << 5) >= 32 * 1024)
  return;
 for(int i = 0; i < 32; i++){
_ssdm_op_SpecPipeline(1, 1, 1, 0, "");
 for(int j = 0; j < 32; j++){
...
void matrix_mult(int A[32][32], int B[32][32], int C[32][32], bool relu){_ssdm_SpecArrayDimSize(A, 32);_ssdm_SpecArrayDimSize(B, 32);_ssdm_SpecArrayDimSize(C, 32);
_ssdm_SpecArrayReshape( A, 2,  "COMPLETE",  0, "");
...
void max_2x2_pooling(int feature_in[32][32], int feature_out[32/2][32/2]){_ssdm_SpecArrayDimSize(feature_in, 32);_ssdm_SpecArrayDimSize(feature_out, 16);
_ssdm_SpecArrayReshape( feature_in, 2,  "COMPLETE",  0, "");
_ssdm_SpecArrayReshape( feature_out, 2,  "COMPLETE",  0, "");
 for(int i = 0; i < 32; i += 2){
_ssdm_op_SpecPipeline(1, 1, 1, 0, "");
 for(int j = 0; j < 32; j += 2){
   int t1 = max(feature_in[i][j], feature_in[i][j + 1]);
   int t2 = max(feature_in[i + 1][j], feature_in[i + 1][j + 1]);
